		...
		if ( !is_plugin_active('getbowtied-tools/getbowtied-tools.php') ): ?>
			<div class="inner">
				...
				<?php 
					...
					echo $actions['button'];
				?>
				<br/><a href="https://shopkeeper-help.zendesk.com/hc/en-us/articles/206678019-Getting-Started"  target="_blank" class="video-guide"><span class="dashicons dashicons-video-alt3"></span> <?php echo __("Installation & Setup <span class='dashicons dashicons-minus'></span> Video Guide"); ?></a>
