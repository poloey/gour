...
function shopkeeper_custom_styles() {	
	...
	<style>
		...
		<?php //if ( (isset($shopkeeper_theme_options['main_font']['font-family'])) && (trim($shopkeeper_theme_options['main_font']['font-family']) != "" ) ) : ?>			
			...
			{ 
				font-family: 
				<?php echo '\'' . $shopkeeper_theme_options['main_font']['font-family'] . '\','; ?> 
				sans-serif;
			}			
		<?php //endif; ?>
		...
		<?php //if ( (isset($shopkeeper_theme_options['secondary_font']['font-family'])) && (trim($shopkeeper_theme_options['secondary_font']['font-family']) != "" ) ) : ?>
			...
			{
				font-family: 
				<?php echo '\'' . $shopkeeper_theme_options['secondary_font']['font-family'] . '\','; ?> 
				sans-serif;
			}			
		<?php //endif; ?>
		...
		<?php 
			...
			if (!empty($shopkeeper_theme_options['headings_font_size'])): 
				...
				$h6_size = $headings_base_size * 0.563;
				...
				$h6_size_mobile = $mobile_base_size * 0.563;
				...
				h6, .woocommerce h6, .woocommerce-page h6 { font-size: <?php echo $h6_size_mobile; ?>px; }
				...
				@media only screen and (min-width: 768px) {
					...
					h6, .woocommerce h6, .woocommerce-page h6 { font-size: <?php echo $h6_size; ?>px; }
